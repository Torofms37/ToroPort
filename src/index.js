const images = [
  { src: "./img/1.JPG", title: "Batatabit", description: "D2-PLAN ayuda a resolver barreras del diseño de la planeación y su complejidad. Con este proyecto inicié en el mundo del Frontend", lenguajes: "Lenguajes utilizados:"},
  ...
  { src: "./img/7.JPG", title: "CreeperGrid", description: "Se diseñó una cara de Creeper del juego Minecraft con el método CSS GRID. Estuvve practicando el cómo utilizar GRID TEMPLATES Y GRID AREAS. ", lenguajes: "Lenguajes utilizados:" },
  ...
  { src: "./img/12.JPG", title: "Portf-1", description: "Intenté hacer mi portafolio web con uso de HMTML, CSS Y JS. Este fue mi primer intento de hacer un web con mis habilidades adquiridas en este proceso.", lenguajes: "Lenguajes utilizados:" },
];
